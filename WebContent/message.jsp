   ...
   function filterText(sText) {
    ...
    function showText() {
     ...
     function getReplyInfo(replyid){
          ...
          function getMore() {
            if (confirm("请先登录！登陆后查看更多内容") !="0"){ window.location.href="<%=basePath%>login.jsp?msgid="+msgId;}
		...
		<div class="row reply template">
			...
			<div class="col-sm-2 col-xs-2">
				...
				<div class="author"></div>
                                ...
                                <div><a href='' class="userimg1"><img style="border-radius:50%" width="55px" height="55px" class="userimg" name="userimg" id="userimg" style="vertical-align:middle"></a></div>
				<div class="sex"></div>
				<div class="city"></div>
			</div>
				...
				<div class="emoji">
					<div class="msgcontent"></div>
                                        <div align="left" style="float:left">
                                           <button class="btn btn-primary btn-sm edit2" style="display: none"><span class="glyphicon glyphicon-pencil">编辑</span></button>
                                        </div>
                                        <div align="right">
                                           <button class="btn btn-danger btn-sm delete_btn" style="display: none"><span class="glyphicon glyphicon-trash">删除</span></button>
                                        </div></br>
                                        <span class="replyupdatetime" style="white-space:nowrap;"></span><a class="relname"></a>
                                        <div><button class="btn btn-white btn-xs zan" style="height: 22px;float: right;" >
                     ...
                     <c:if test="${sessionScope.user == null}">
                        <p style="display: block">
                            <a href="javascript:;" id="mgc_post_15215922" onmouseover="showMenu(this.id)" class="showmenu" style="display: none;"></a>
                    ...
                    <c:if test="${sessionScope.user != null}">
                        <p style="display: none" class="reportButton">
                            <a href="javascript:;" id="mgc_post" onmouseover="showMenu(this.id)" class="showmenu" style="display: none;"></a>
		...
		<div class="row">
            ...
            <c:when test="${sessionScope.user!= null ||sessionScope.admin!=null }">
				<button id="loadmore" type="button" class="btn btn-default btn-lg btn-block"
                        onclick="getReply()" disabled="disabled">加载更多...</button>
            </c:when>
            <c:otherwise>
	    			...
	    			<textarea style="width:100%" rows="5" cols="" id="replycontent"></textarea>
	    			 ...
	    			 <form id="replyform">
	    			 	<div class="form-group">
	    			 		<textarea style="width:100%" rows="5" cols="0" name="replycontent" id="replycontent" onblur="showText();" class="ckeditor"></textarea>
							<script type="text/javascript">
    ...
    <div class="modal-dialog">
        <div class="modal-content modalcenter">
            ...
            <div class="modal-body">
                <form id="replyform2">
                    <div class="form-group">
                        <textarea style="width:100%" rows="5" cols="0" name="replycontent2" id="replycontent2" onblur="showText2();" class="ckeditor"></textarea>
            ...
            <div class="modal-content modalcenter">
                <div class="modal-header">
                    ...
                    <table cellpadding="0" cellspacing="0" class="fwin">
                        <tbody><tr><td class="t_l"></td><td class="t_c" style="cursor:move" onmousedown="dragMenu($('fwin_miscreport15215922'), event, 1)" ondblclick="hideWindow('miscreport15215922')"></td><td class="t_r"></td></tr><tr><td class="m_l" style="cursor:move" onmousedown="dragMenu($('fwin_miscreport15215922'), event, 1)" ondblclick="hideWindow('miscreport15215922')" )"="">&nbsp;&nbsp;</td><td class="m_c" id="fwin_content_miscreport15215922" fwin="miscreport15215922" style="">
                            ...
                            <td class="m_r" style="cursor:move" onmousedown="dragMenu($('fwin_miscreport15215922'), event, 1)" ondblclick="hideWindow('miscreport15215922')">
                        </tr>
                        <tr>
                            <td class="b_l"></td><td class="b_c" style="cursor:move" onmousedown="dragMenu($('fwin_miscreport15215922'), event, 1)" ondblclick="hideWindow('miscreport15215922')"></td><td class="b_r">
                        </td>
                        </tr>
                        </tbody>
                    </table>
                        ...
                        <div class="reason_slct c" id="return_miscreport15215922" fwin="miscreport15215922">
                           ...
                           <p></p>
                            ...
                            <div id="report_other" style="display:none;" fwin="miscreport15215922">
                                <textarea placeholder="请填写举报内容" style="margin: 0px; width: 557px; height: 101px;resize:vertical;" id="report_message" name="message" class="reasonarea pt mtn xg1" onfocus="this.innerHTML='';this.focus=null;this.className='reasonarea pt mtn'" onkeydown="ctrlEnter(event, 'reportsubmit', 1);" rows="4" fwin="miscreport15215922">请填写举报内容</textarea>
                            </div>
                        </div>
                        <p class="o pns">
