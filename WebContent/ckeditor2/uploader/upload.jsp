...
//			String jsonResult = "{\"uploaded\" : uploadedNum, \"fileName\" : \"fileNameStr\", \"url\":\"path\" , \"error\" : { \"message\":\"errorMsg\" } }";
//			JSONObject obj = new JSONObject();
//			obj.put("uploaded", 1); obj.put("fileName", genePicfileName); obj.put("url", fullFilePathString); out.write(obj.toString());
