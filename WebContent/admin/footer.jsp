...
<head>
	...
	<SCRIPT language=javascript>
        ...
        function show_date_time(){
            ...
            BirthDay=new Date("05-2-2018"); //烈火网提示：这里的07-31-2009是指建站日期
            today=new Date();
			...
			<div class="col-sm-6  col-lg-5 col-lg-offset-1">
				<div class="row about">
					<div class="col-xs-3">
						...
						<ul class="list-unstyled">
							...
							<li><a href="https://www.500d.me/cvresume/5246633084/" _blank>个人简介</a></li>
							 <li><a href="http://www.lidiwen.club/ForestBlog/img/weixin.jpg">广告合作</a></li>
					...
					<div class="col-xs-3">
						<h4>赞助商</h4>
						<ul class="list-unstyled">
							<li><a href="images/晓琪.jpg" _blank>黄晓琪</a></li>
							<li><a href="images/李弟文.jpg" _blank>李弟文</a></li>
						</ul>
					</div>
