...
<head>
   ...
   <link rel="stylesheet" href="http://love.lidiwen.club/bootstrap.min.css">
    ...
    <script type="text/javascript">
        ...
        $(function(){
            if($("input[name='msgtopic']").val()==""||$("input[name='msgtopic']").val()==null){
        ...
        function updatemsg(){
            ...
            var msgid=$("input[name='msgid']").val();//帖子id
            showText();
        ...
        function showText() {
            var oInput1 = CKEDITOR.instances.msgcontents.getData();
            oInput1 = filterText(oInput1);
            CKEDITOR.instances.msgcontents.setData(oInput1);
        }
    </script>
</head>
<body>
...
<div class="container">
    <div class="row">
        <div class="col-sm-12 text-center">
            <h3>修改我的提问信息</h3>
            <input type="hidden" value="${msg.msgid}" name="msgid">
        </div>
    </div>
    <form class="form-horizontal col-sm-offset-2" id="addmsgform" method="post">
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <input type="text" class="form-control" name="msgtopic" autofocus="autofocus" placeholder="请输入标题" value="${msg.msgtopic}">
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <select class="form-control" name="theid">
                    <option value="${msg.theid}" selected>${msg.thename}</option>
                </select>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <div>请一句话说明你的问题，以问号结尾</div>
                <textarea  style="width:100%" rows="5" name="msgcontents" id="msgcontents"  onblur="showText();" class="ckeditor" placeholder="请一句话说明你的问题，以问号结尾">${msg.msgcontents}</textarea>
        ...
        <div class="form-group">
            <div class="col-sm-offset-2 col-sm-3 col-xs-12">
                <button class="btn btn-success" onclick="updatemsg();">更新</button>
