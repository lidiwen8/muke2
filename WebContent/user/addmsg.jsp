	...
	<form class="form-horizontal col-sm-offset-2" id="addmsgform" method="post">
		...
		<div class="form-group">
			...
			<div class="col-sm-6">
				...
				<textarea  style="width:100%" rows="5" name="msgcontents" id="msgcontents"  onblur="showText();" class="ckeditor" placeholder="请一句话说明你的问题，以问号结尾"></textarea>
...
<script type="text/javascript">
   document.write("<scr"+"ipt src=\"http://www.lidiwen.club:8083/ckeditor2/ckeditor.js\" language=\"JavaScript\" charset=\"gb2312\"></sc"+"ript>")
</script>
