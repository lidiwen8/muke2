...
<div class="container">
    <div class="row">
        <div class="col-sm-12">
            ...
            <c:otherwise>
                <button id="loadmore1" type="button" class="btn btn-default btn-lg btn-block" data-toggle="modal"
                        onclick="getMore()">登录后查看更多！
                </button>
            </c:otherwise>
            </c:choose>
        </div>
