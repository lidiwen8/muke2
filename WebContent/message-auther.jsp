            ...
            if ($.trim(replycontents).length == 0) {
                ...
                $.post("user/userMessageServlet",
                    ...
                    function (data) {
                        ...
                        //加载更多
                        // pageNum++;
                        if (parseInt(data.LastPage) > parseInt(pageNum)) {
                            $("#loadmore").html("加载更多...");
                            $("#loadmore").removeAttr("disabled");
        ...
        function createWebSocket(wsUrl) {
            try {
                ...
                websocket.onmessage = function (event) {
                    ...
                    if(event.data.split(",")[0]=="ReplyUpdateAuther"+msgId||event.data.split(",")[0]=="ReplyDelete"+msgId||event.data.split(",")[0]=="ReplyDeleteByAuther"+msgId||event.data.split(",")[0]=="ReplyDeleteAuther"+msgId){
                        ...
                        if($("#userid").val()==null||($("#userid").val()!=null&&$("#userid").val()!=userid&&(event.data.split(",")[0]=="ReplyDeleteAuther"+msgId||event.data.split(",")[0]=="ReplyUpdateAuther"+msgId))) {
    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <button id="loadmore" type="button" class="btn btn-default btn-lg btn-block"
                    onclick="getAuthorReply()" disabled="disabled">加载更多...
                <%--onclick="javascript:getReply();"--%>
                <br/>
