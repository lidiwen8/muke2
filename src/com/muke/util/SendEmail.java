...
public class SendEmail {
    ...
    public String sendMsg(String adress, String password, String username,String key,String email) throws MessagingException {
        String msg2="<p>【爱之家科技有限公司】提醒你：您好 O(∩_∩)O~~<br>用户名："+username+"<br>新密码："+password+"<br>请在5分钟内点击下面的链接新密码才能生效：<br><a href='http://www.lidiwen.club/muke_Web/password_reset.jsp?username=" + username + "&key=" + key + "&email="+email+"'>http://www.lidiwen.club/muke_Web/password_reset.jsp?username=" + username + "&key=" + key + "&email="+email+"</a></p>";
        return msg2;
    }
